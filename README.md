...
*   **`assets/flutter-template/`**: A fully functional Clean Architecture starter project implementing the patterns from the references, including preconfigured Fastlane lanes for Android and iOS.
...
4.  **Run release automation with Fastlane**:
    ```bash
    cd ../my_amazing_app
    bundle install
